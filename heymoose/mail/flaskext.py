...
"""
    ...
    Flask-Mail clone from https://github.com/mattupstate/flask-mail
...
class Connection(object):
    ...
    def send(self, message):
        ...
        self.app.logger.info(u'Sending mail with subject <{0}> to {1}'.format(message.subject, list(message.send_to)))
