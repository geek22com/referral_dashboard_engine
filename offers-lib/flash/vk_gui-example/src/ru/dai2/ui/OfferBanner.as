package ru.dai2.ui
{
    ...
    [Event(name = OfferEvent.OFFER_CLICKED, type = "ru.dai2.events.OfferEvent")]
    public class OfferBanner extends MovieClip
    {
        ...
        public static function create(x : int, y : int, delay : int, offersService : OffersService,
                                      rewardCallbak : Function) : OfferBanner 
        {
